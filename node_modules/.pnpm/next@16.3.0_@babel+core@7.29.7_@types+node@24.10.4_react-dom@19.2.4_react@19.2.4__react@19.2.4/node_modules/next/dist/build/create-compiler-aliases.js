...
const _browservariantmodules = require("./browser-variant-modules");
 ...
 * `webpack-config.ts`.
 */ const INSTRUMENTATION_CLIENT_STUB_PATH = _path.default.join(_nextdirpaths.NEXT_PROJECT_ROOT, 'dist/build/webpack/loaders/instrumentation-client-stub.js');
function createWebpackAliases({ distDir, isClient, isEdgeServer, dev, config, pagesDir, appDir, dir, reactProductionProfiling }) {
    ...
    return {
        ...
        ...isClient ? {
            ...
            ...Object.fromEntries(_browservariantmodules.browserVariantModules.map((moduleId)=>[
                    _path.default.join(_nextdirpaths.NEXT_PROJECT_ROOT_DIST, `${moduleId}.js`) + '$',
            ...
            ...!dev && config.experimental.exposeTestingApiInProductionBuild !== true ? {
                [_path.default.join(_nextdirpaths.NEXT_PROJECT_ROOT_DIST, 'client/components/segment-cache/navigation-testing-lock.js') + '$']: 'next/dist/client/components/segment-cache/navigation-testing-lock.disabled'
            } : {}
        } : {},
