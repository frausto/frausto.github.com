...
function nextJest(options = {}) {
    ...
    return (customJestConfig)=>{
        ...
        return async ()=>{
            ...
            const imageConfig = (nextConfig == null ? void 0 : nextConfig.images) ? {
            ...
            const transpiled = ((nextConfig == null ? void 0 : nextConfig.transpilePackages) ?? []).concat(DEFAULT_TRANSPILED_PACKAGES).concat(imageConfig ? [
