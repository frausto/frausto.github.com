   ...
   */ apply(compiler) {
        ...
        compiler.hooks.compilation.tap('NextJSEvalSourceMapDevToolPlugin', (compilation)=>{
            ...
            hooks.renderModuleContent.tap('NextJSEvalSourceMapDevToolPlugin', (source, m, { chunk, runtimeTemplate, chunkGraph })=>{
                ...
                const moduleResource = m instanceof _webpack.NormalModule ? m.resource : undefined;
                const moduleIsIgnored = moduleResource !== undefined && this.shouldIgnorePath(moduleResource);
                ...
                for(let index = 0; index < moduleFilenames.length; index++){
                    ...
                    if (this.shouldIgnorePath(moduleFilenames[index]) || moduleIsIgnored && sourceIsUnresolved) {
