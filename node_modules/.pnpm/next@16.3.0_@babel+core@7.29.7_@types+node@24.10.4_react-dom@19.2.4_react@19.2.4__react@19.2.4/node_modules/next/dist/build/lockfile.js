        ...
        if (lockfile === undefined) {
            ...
            if (isDev) {
                ...
                if (serverInfo) {
                    ...
                    console.error();
                    console.error(`You can access the existing server at ${(0, _picocolors.cyan)(serverInfo.appUrl)},`);
                    ...
                    console.error(`or run ${(0, _picocolors.cyan)(killCommand)} to stop it and start a new one.`);
                } else {
