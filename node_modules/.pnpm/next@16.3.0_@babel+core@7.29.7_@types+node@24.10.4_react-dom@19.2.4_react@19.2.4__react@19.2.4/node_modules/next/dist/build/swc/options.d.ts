...
export declare function getJestSWCOptions({ isServer, filename, esm, modularizeImports, configDir, swcPlugins, compilerOptions, jsConfig, resolvedBaseUrl, pagesDir, imageConfig, serverReferenceHashSalt, }: {
    isServer: boolean;
    filename: string;
    esm: boolean;
    configDir?: string;
    ...
    serverComponents: {
        ...
        taintEnabled: boolean | undefined;
