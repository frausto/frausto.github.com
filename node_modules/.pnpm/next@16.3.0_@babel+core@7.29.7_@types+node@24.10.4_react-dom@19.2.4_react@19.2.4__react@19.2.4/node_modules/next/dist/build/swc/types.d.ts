...
import type { ExternalObject, RefCell, NapiTurboEngineOptions, NapiSourceDiagnostic, NapiProjectOptions, NapiPartialProjectOptions, NapiCodeFrameOptions, NapiCodeFrameLocation, TraceServerHandle, TraceQueryOptions, TraceQueryResult, MemoryEvictionMode } from './generated-native';
...
export interface Project {
    ...
    allHmrEvents(target: import('./index').HmrTarget.Server): AsyncIterableIterator<TurbopackResult<NodeJsHmrUpdate>>;
