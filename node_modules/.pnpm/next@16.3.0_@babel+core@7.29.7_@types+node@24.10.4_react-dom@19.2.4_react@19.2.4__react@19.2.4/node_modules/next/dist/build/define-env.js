...
function getDefineEnv({ isTurbopack, clientRouterFilters, config, dev, distDir, projectPath, fetchCacheKeyPrefix, hasRewrites, isClient, isEdgeServer, isNodeServer, middlewareMatchers, omitNonDeterministic, rewrites }) {
    ...
    const defineEnv = {
        ...
        'process.env.__NEXT_DISABLE_DEV_OVERLAY_UX': process.env.NEXT_PRIVATE_DISABLE_DEV_OVERLAY_UX === '1',
        ...
        'process.env.__NEXT_REQUEST_INSIGHTS': dev && !!config.experimental.requestInsights,
        'process.env.__NEXT_USE_CACHE': isUseCacheEnabled,
        'process.env.__NEXT_USE_NODE_STREAMS': isEdgeServer ? false : true,
        'process.env.NEXT_SUPPORTS_IMMUTABLE_ASSETS': config.supportsImmutableAssets || false,
        ...
        'process.env.__NEXT_SERVER_COMPONENTS_HMR_CANCELLATION': Boolean(config.experimental.serverComponentsHmrCancellation),
