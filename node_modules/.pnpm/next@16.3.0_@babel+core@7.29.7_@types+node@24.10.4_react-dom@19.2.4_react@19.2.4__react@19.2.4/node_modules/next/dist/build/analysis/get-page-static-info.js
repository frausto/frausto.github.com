...
async function getAppPageStaticInfo({ pageFilePath, nextConfig, isDev, page }) {
    ...
    if ((directives == null ? void 0 : directives.has('client')) && 'instant' in config) {
        throw Object.defineProperty(new Error(`"instant" is a route segment config and can only be used when the segment is a Server Component module. Remove the "use client" directive from "${pageFilePath}" to use this API.`), "__NEXT_ERROR_CODE", {
            value: "E1344",
            enumerable: false,
            configurable: true
        });
    ...
    if ('instant' in config && !nextConfig.cacheComponents) {
        throw Object.defineProperty(new Error(`Route "${page}" cannot use \`export const instant = ...\` without enabling \`cacheComponents\`.`), "__NEXT_ERROR_CODE", {
            value: "E1162",
            enumerable: false,
            configurable: true
        });
    ...
    if ((directives == null ? void 0 : directives.has('client')) && 'prefetch' in config) {
        throw Object.defineProperty(new Error(`"prefetch" is a route segment config and can only be used when the segment is a Server Component module. Remove the "use client" directive from "${pageFilePath}" to use this API.`), "__NEXT_ERROR_CODE", {
            value: "E1323",
            enumerable: false,
            configurable: true
        });
    ...
    if ('prefetch' in config && !nextConfig.cacheComponents) {
        throw Object.defineProperty(new Error(`Route "${page}" cannot use \`export const prefetch = ...\` without enabling \`cacheComponents\`.`), "__NEXT_ERROR_CODE", {
            value: "E1322",
            enumerable: false,
            configurable: true
        });
    ...
    if ('unstable_dynamicStaleTime' in config && 'instant' in config) {
        throw Object.defineProperty(new Error(`Page "${page}" cannot use both \`export const unstable_dynamicStaleTime\` and \`export const instant\`.`), "__NEXT_ERROR_CODE", {
            value: "E1343",
            enumerable: false,
            configurable: true
        });
