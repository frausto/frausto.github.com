 ...
 */
export declare function parseNormalizedAppRoute(pathname: string): NormalizedAppRoute;
/**
 ...
 * parallel slots.
 */
export declare function parseAppRouteWithSlots(pathname: string): AppRoute;
