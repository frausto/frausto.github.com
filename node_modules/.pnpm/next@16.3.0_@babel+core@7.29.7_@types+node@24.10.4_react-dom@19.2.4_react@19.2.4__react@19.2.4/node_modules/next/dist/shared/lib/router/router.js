...
const _dynamicfilterpattern = require("./utils/dynamic-filter-pattern");
...
const _javascripturl = require("../../../client/lib/javascript-url");
let resolveRewrites;
...
class Router {
   ...
   */ replace(url, as, options = {}) {
    ...
    async change(method, url, as, options, forcedScroll) {
        ...
        // dynamic filter.
        if (!isQueryUpdating && !options.shallow && process.env.__NEXT_CLIENT_ROUTER_FILTER_ENABLED && this._bfl_d && (0, _isdynamic.isDynamicRoute)(pathname)) {
