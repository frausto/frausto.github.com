    ...
    return async function handler(req, res, ctx) {
        ...
        const render404 = async ()=>{
            ...
            if (routerServerContext == null ? void 0 : routerServerContext.render404) {
                ...
                if (nextConfig.cacheComponents && !routerServerContext.isWrappedByNextServer && typeof (0, _requestmeta.getRequestMeta)(req, 'postponed') !== 'string') {
                    (0, _requestmeta.addRequestMeta)(req, 'postponed', '');
                }
