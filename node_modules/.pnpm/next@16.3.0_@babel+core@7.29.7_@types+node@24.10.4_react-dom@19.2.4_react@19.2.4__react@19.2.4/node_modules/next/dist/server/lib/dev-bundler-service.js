...
class DevBundlerService {
    constructor(bundler, handler, requestInsightsEnabled){
        this.bundler = bundler;
        this.handler = handler;
        this.close = ()=>{
            this.unsubscribeRequestInsights == null ? void 0 : this.unsubscribeRequestInsights.call(this);
        ...
        if (requestInsightsEnabled) {
            this.unsubscribeRequestInsights = (0, _requestinsights.subscribeRequestInsights)((insight)=>{
                hotReloader.send({
                    type: _hotreloadertypes.HMR_MESSAGE_SENT_TO_BROWSER.REQUEST_INSIGHTS_UPDATE,
                    insight
                });
            });
        }
