...
type NextAttributeNames = 'next.route' | 'next.page' | 'next.rsc' | 'next.segment' | 'next.span_category' | 'next.span_name' | 'next.span_type' | 'next.clientComponentLoadCount';
...
declare class NextTracerImpl implements NextTracer {
    ...
    private isOpenTelemetryEnabled;
    getContext(): ContextAPI;
    getTracePropagationData(): ClientTraceDataEntry[];
    getActiveScopeSpan(): Span | undefined;
    /**
