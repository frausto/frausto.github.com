...
const API_DOCS = {
    ...
    prefetch: {
        ...
        options: {
            ...
            partial: 'Enables Partial Prefetching for this segment. When a static prefetch is insufficient, Next.js may prefetch the segment with a runtime server request so it can access session data, such as cookies.',
            unstable_eager: 'Like "partial", but adds an implied prop of prefetch={true} to ' + 'every Link. This option only exists to aid migration of apps that ' + 'adopted Partial Prefetching in canary before the behavior changed to ' + 'only fetch the shell by default.',
...
const config = {
    ...
    getQuickInfoAtPosition (fileName, position, prior) {
        const ts = (0, _utils.getTs)();
        let overridden;
        visitEntryConfig(fileName, position, (entryConfig, declaration)=>{
            ...
            if (value && !isFunctionValue && (0, _utils.isPositionInsideNode)(position, value)) {
                ...
                if (isValid) {
                    ...
                    const documentation = [
                        ...(prior == null ? void 0 : prior.documentation) || [],
                        {
                            kind: 'text',
