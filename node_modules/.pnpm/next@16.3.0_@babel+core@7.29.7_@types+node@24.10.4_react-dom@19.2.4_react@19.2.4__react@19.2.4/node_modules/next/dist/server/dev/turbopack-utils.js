        ...
        case 'app-page':
            {
                ...
                if (dev) {
                    ...
                    hooks == null ? void 0 : hooks.subscribeToChanges(key, /** includeIssues=*/ true, route.rscHmrEndpoint, (change)=>{
                        var _globalThis___turbopack_server_hmr_handlers__, _hooks_handleServerComponentChanges;
                        ...
                        const hasLiveServerHmrHandler = (((_globalThis___turbopack_server_hmr_handlers__ = globalThis.__turbopack_server_hmr_handlers__) == null ? void 0 : _globalThis___turbopack_server_hmr_handlers__.size) ?? 0) > 0;
                        if ((hooks == null ? void 0 : hooks.serverFastRefresh) && hasLiveServerHmrHandler) {
                            return;
                        }
