...
const experimentalSchema = {
    ...
    devMemoryThresholdRestart: _zod.z.boolean().optional(),
    ...
    turbopackChunking: _zod.z.object({
        ...
        requestCost: _zod.z.number().min(0).finite().optional(),
        minChunkSize: _zod.z.number().min(0).optional(),
        maxChunkCountPerGroup: _zod.z.number().min(0).optional(),
        maxMergeChunkSize: _zod.z.number().min(0).optional(),
        minComponentChunkSize: _zod.z.number().min(0).optional(),
        generateComponentChunks: _zod.z.boolean().optional()
    }).optional(),
