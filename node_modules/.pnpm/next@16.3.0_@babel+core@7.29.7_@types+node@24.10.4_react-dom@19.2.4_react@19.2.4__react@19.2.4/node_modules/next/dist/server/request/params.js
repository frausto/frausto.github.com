                ...
                if (fallbackParams) {
                    for(let key in underlyingParams){
                        if (fallbackParams.has(key)) {
                            ...
                            // resolves.
                            return (0, _dynamicrenderingutils.makeFallbackParamsHangingPromise)(workUnitStore.renderSignal, workStore.route, '`params`', workUnitStore);
                        }
                    }
                }
                break;
            ...
            return ({
                [prop]: (...args)=>{
                    ...
                    if (workUnitStore !== undefined) {
                        (0, _dynamicrenderingutils.trackFallbackParamsAccessed)(workUnitStore);
                    }
...
function makeHangingParams(underlyingParams, workStore, prerenderStore) {
    ...
    const promise = new Proxy((0, _dynamicrenderingutils.makeFallbackParamsHangingPromise)(prerenderStore.renderSignal, workStore.route, '`params`', // This promise is created for every segment on a fallback route whether
