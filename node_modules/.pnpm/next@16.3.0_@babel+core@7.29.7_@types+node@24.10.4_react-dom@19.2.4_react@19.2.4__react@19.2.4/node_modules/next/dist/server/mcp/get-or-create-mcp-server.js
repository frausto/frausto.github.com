...
const _compileroute = require("./tools/compile-route");
const _getrequestinsights = require("./tools/get-request-insights");
let mcpServer;
const getOrCreateMcpServer = (options)=>{
    ...
    (0, _getrequestinsights.registerGetRequestInsightsTool)(mcpServer);
    ...
    if (options.compileRoute) {
        (0, _compileroute.registerCompileRouteTool)(mcpServer, options.compileRoute);
    }
    return mcpServer;
};
