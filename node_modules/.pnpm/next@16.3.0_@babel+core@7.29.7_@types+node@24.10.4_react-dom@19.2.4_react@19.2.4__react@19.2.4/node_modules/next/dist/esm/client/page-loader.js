...
import { createRouteLoader, getClientBuildManifest, markAssetError } from './route-loader';
import { DEV_CLIENT_PAGES_MANIFEST, DEV_CLIENT_MIDDLEWARE_MANIFEST } from '../shared/lib/constants';
    ...
    getMiddleware() {
        ...
        // Turbopack production
            ...
            if (window.__MIDDLEWARE_MATCHERS) {
                ...
                return resolvePromiseWithTimeout(onClientMiddlewareManifest, markAssetError(Object.defineProperty(new Error('Failed to load client middleware manifest'), "__NEXT_ERROR_CODE", {
                    value: "E980",
                    enumerable: false,
                    configurable: true
                })), undefined);
