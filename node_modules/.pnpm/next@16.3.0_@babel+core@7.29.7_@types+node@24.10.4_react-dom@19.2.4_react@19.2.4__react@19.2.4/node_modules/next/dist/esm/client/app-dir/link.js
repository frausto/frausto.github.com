...
function linkClicked(e, href, linkInstanceRef, replace, scroll, onNavigate, transitionTypes, prefetchIntent = 'none') {
    if (typeof window !== 'undefined') {
        ...
        const { dispatchNavigateAction } = // TODO(browser-variant): migrate to a .ts/.browser.ts split so the browser bundle drops the server branch; see scripts/generate-browser-variant-aliases.mjs
 ...
 */ export default function LinkComponent(props) {
    ...
    // this <Link>.
    const ownerStack = process.env.NODE_ENV !== 'production' && process.env.__NEXT_CACHE_COMPONENTS ? React.useMemo(()=>{
    ...
    const observeLinkVisibilityOnMount = React.useCallback((element)=>{
        if (router !== null) {
            linkInstanceRef.current = mountLinkInstance(element, formattedHref, router, fetchStrategy, prefetchEnabled, setOptimisticLinkStatus, ownerStack);
        }
        return ()=>{
