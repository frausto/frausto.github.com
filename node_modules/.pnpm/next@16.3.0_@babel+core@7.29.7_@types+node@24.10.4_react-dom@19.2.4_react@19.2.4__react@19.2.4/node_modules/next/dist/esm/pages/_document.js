...
import { getPageFiles, getTurbopackChunkGroupBootstrap } from '../server/get-page-files';
...
function getInlineBootstrapScript(context, props) {
    ...
    const bootstrap = getTurbopackChunkGroupBootstrap(buildManifest.pagesChunkGroupBootstrapParams, buildManifest.chunkLoadingGlobal, [
        '/_app',
        __NEXT_DATA__.page
    ]);
