 ...
 * `webpack-config.ts`.
 */ const INSTRUMENTATION_CLIENT_STUB_PATH = path.join(NEXT_PROJECT_ROOT, 'dist/build/webpack/loaders/instrumentation-client-stub.js');
export function createWebpackAliases({ distDir, isClient, isEdgeServer, dev, config, pagesDir, appDir, dir, reactProductionProfiling }) {
    ...
    return {
        ...
        ...isClient ? {
            ...
            ...Object.fromEntries(browserVariantModules.map((moduleId)=>[
            ...
            ...!dev && config.experimental.exposeTestingApiInProductionBuild !== true ? {
                [path.join(NEXT_PROJECT_ROOT_DIST, 'client/components/segment-cache/navigation-testing-lock.js') + '$']: 'next/dist/client/components/segment-cache/navigation-testing-lock.disabled'
            } : {}
        } : {},
