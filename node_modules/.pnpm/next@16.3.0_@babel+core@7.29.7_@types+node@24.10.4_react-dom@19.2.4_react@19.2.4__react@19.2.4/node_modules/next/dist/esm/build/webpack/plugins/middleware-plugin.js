...
function getEntrypointFile(entrypoint) {
    ...
    const file = getJsFile(entrypoint.getEntrypointChunk().files) || getJsFile(entrypoint.getFiles());
    if (!file) {
        throw Object.defineProperty(new Error('Expected edge function entrypoint to emit a JavaScript file'), "__NEXT_ERROR_CODE", {
            value: "E1119",
            enumerable: false,
            configurable: true
        });
