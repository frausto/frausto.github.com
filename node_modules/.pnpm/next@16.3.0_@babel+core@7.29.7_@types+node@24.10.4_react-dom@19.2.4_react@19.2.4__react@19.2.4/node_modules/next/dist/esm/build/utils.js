 ...
 */ function getTreeViewDisplayPath(pagePath) {
    const prerenderPathname = getStaticMetadataPrerenderPathname(pagePath.startsWith('/') ? pagePath : `/${pagePath}`);
    ...
    return isPageStaticSpan.traceAsyncFn(async ()=>{
        ...
        if (pageType === 'app') {
            ...
            if (route.dynamicSegments.length > 0 && !pathIsEdgeRuntime) {
                ...
                if (routeModule.definition.kind === RouteKind.APP_ROUTE && isStaticMetadataFile(pathname)) {
                    ;
