...
function warnDeprecatedCustomServerMethod(method) {
    log.warnOnce(`The \`app.${method}()\` method is deprecated in custom servers. ${DEPRECATED_CUSTOM_SERVER_METHOD_GUIDANCE[method]}`);
}
/** The wrapper server used by `next start` */ export class NextServer {
    ...
    getRequestHandler() {
        return async (req, res, parsedUrl)=>{
            ...
            return tracer.withPropagatedContext(req.headers, ()=>tracer.trace(NextServerSpan.getRequestHandler, async ()=>{
   ...
   */ getRequestHandlerWithMetadata(meta) {
        return async (req, res, parsedUrl)=>{
            const tracer = getTracer();
            return tracer.withPropagatedContext(req.headers, ()=>tracer.trace(NextServerSpan.getRequestHandlerWithMetadata, async ()=>{
