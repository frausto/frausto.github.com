 ...
 */ export function instrumentModuleGetter(getter) {
    if (process.env.NEXT_RUNTIME === 'edge' || !process.env.__NEXT_CACHE_COMPONENTS) {
        ...
        return ()=>{
            const { trackPendingImport } = require('./track-module-loading.external');
...
//# sourceMappingURL=instrument-module-getter.js.map