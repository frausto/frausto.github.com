...
import { getCacheSignal, getResumeDataCache, workUnitAsyncStorage } from './work-unit-async-storage.external';
...
export const encryptActionBoundArgs = React.cache(async function encryptActionBoundArgs(actionId, ...args) {
    ...
    const resumeDataCache = workUnitStore ? getResumeDataCache(workUnitStore) : null;
