...
import { renderToNodeFizzStream, renderToWebFizzStream, streamToString } from './stream-ops';
export function makeGetServerInsertedHTML({ polyfills, renderServerInsertedHTML, serverCapturedErrors, tracingMetadata, basePath }) {
    ...
    return async function getServerInsertedHTML() {
        ...
        const { stream } = await (process.env.__NEXT_USE_NODE_STREAMS ? renderToNodeFizzStream : renderToWebFizzStream)(/*#__PURE__*/ _jsxs(_Fragment, {
            children: [
                polyfillTags,
                serverInsertedHTML,
                traceMetaTags,
