 ...
 */ export async function walkTreeWithFlightRouterState({ loaderTreeToFilter, parentParams, flightRouterState, parentIsInsideSharedLayout, rscHead, injectedCSS, injectedJS, injectedFontPreloadTags, rootLayoutIncluded, ctx, preloadCallbacks, MetadataOutlet, hintTree }) {
   ...
   */ const renderComponentsOnThisLevel = // No further router state available
    ...
    isPrefetch && !Boolean(modules.loading) && !hasLoadingComponentInTree(loaderTreeToFilter))) {
        ...
        const routerState = parsedRequestHeaders.isRouteTreePrefetchRequest ? await createRouteTreePrefetch(loaderTreeToFilter, hintTree, prefetchInliningEnabled, cacheComponents, partialPrefetching, isStaticGeneration, isBuildTimePrerendering, getDynamicParamFromSegment, rootLayoutIncluded) : await createFlightRouterStateFromLoaderTree(loaderTreeToFilter, hintTree, prefetchInliningEnabled, cacheComponents, partialPrefetching, isStaticGeneration, isBuildTimePrerendering, getDynamicParamFromSegment, query, rootLayoutIncluded);
        return [
            [
                overriddenSegment,
                routerState,
    ...
    if (flightRouterState && flightRouterState[3] === 'metadata-only') {
        ...
        const routerState = parsedRequestHeaders.isRouteTreePrefetchRequest ? await createRouteTreePrefetch(loaderTreeToFilter, hintTree, prefetchInliningEnabled, cacheComponents, partialPrefetching, isStaticGeneration, isBuildTimePrerendering, getDynamicParamFromSegment) : await createFlightRouterStateFromLoaderTree(loaderTreeToFilter, hintTree, prefetchInliningEnabled, cacheComponents, partialPrefetching, isStaticGeneration, isBuildTimePrerendering, getDynamicParamFromSegment, query, rootLayoutIncluded);
        return [
            [
                overriddenSegment,
                routerState,
    ...
    if (renderComponentsOnThisLevel) {
        ...
        loaderTreeToFilter, hintTree, prefetchInliningEnabled, cacheComponents, partialPrefetching, isStaticGeneration, isBuildTimePrerendering, getDynamicParamFromSegment, query, rootLayoutIncluded);
 ...
 */ export async function createFullTreeFlightDataForNavigation({ loaderTree, rscHead, injectedCSS, injectedJS, injectedFontPreloadTags, ctx, preloadCallbacks, MetadataOutlet }) {
    ...
    const routerState = await createFlightRouterStateFromLoaderTree(loaderTree, hintTreeForInitialRender, Boolean(experimental.prefetchInlining), ctx.renderOpts.cacheComponents, ctx.renderOpts.partialPrefetching, workStoreForInitialRender.isStaticGeneration, ctx.renderOpts.isBuildTimePrerendering ?? false, getDynamicParamFromSegment, query);
