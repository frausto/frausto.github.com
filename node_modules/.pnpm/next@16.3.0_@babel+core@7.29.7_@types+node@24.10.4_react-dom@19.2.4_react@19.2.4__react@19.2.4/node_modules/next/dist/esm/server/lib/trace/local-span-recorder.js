...
export function createLocalSpan({ name, attributes, links, startTime, traceId, spanId, parentSpanId, delegateSpan, isolateOpenTelemetry }) {
...
export function isOpenTelemetryIsolatedSpan(span) {
 ...
 */ export async function traceLocalSpan({ parentSpan, ...options }, fn) {
