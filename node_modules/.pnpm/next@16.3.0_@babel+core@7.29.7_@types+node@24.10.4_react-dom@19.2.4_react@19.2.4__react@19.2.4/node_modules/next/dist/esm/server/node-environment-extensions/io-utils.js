                ...
                if (stageController && stageController.shouldTrackSyncInterrupt()) {
                    ...
                    switch(stageController.currentStage){
                        ...
                        case RenderStage.Abandoned:
                            {
                                throw Object.defineProperty(new InvariantError(`shouldTrackSyncInterrupt allowed a sync IO interrupt in an unexpected stage: ${RenderStage[stageController.currentStage]}`), "__NEXT_ERROR_CODE", {
                                    value: "E1420",
                                    enumerable: false,
                                    configurable: true
                                });
