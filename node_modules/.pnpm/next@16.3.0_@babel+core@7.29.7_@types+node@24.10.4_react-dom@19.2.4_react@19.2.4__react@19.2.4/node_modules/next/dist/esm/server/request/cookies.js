                ...
                case 'prerender-runtime':
                    {
                        ...
                        if (stagedRendering) {
                            return stagedRendering.delayUntilStage(RENDER_STAGES_BY_DATA_KIND.sessionData, 'cookies', workUnitStore.cookies);
                        } else {
...
function makeHangingCookies(workStore, prerenderStore) {
    ...
    const promise = makeRuntimeHangingPromise(prerenderStore.renderSignal, workStore.route, '`cookies()`', prerenderStore);
...
function makeUntrackedCookiesWithDevWarnings(requestStore, underlyingCookies, route) {
    ...
    const promise = makeDevtoolsIOAwarePromise(underlyingCookies, requestStore, RENDER_STAGES_BY_DATA_KIND.sessionData);
