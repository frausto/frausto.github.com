 ...
 */ export function getCachedImageResponseBody(args) {
...
async function getCachedImageResponseArrayBuffer(args) {
    ...
    if (!workStore) {
        throw Object.defineProperty(new InvariantError('Expected a work store while caching an `ImageResponse` during prerendering.'), "__NEXT_ERROR_CODE", {
            value: "E1382",
            enumerable: false,
            configurable: true
        });
    ...
    try {
        ...
        if (resultIsPartial) {
            ...
            return makeDynamicHangingPromise(renderSignal, workStore.route, 'dynamic `ImageResponse`');
        }
        ...
        const arrayBufferPromise = workUnitAsyncStorage.exit(()=>renderImageResponseArrayBuffer(resolvedArgs));
