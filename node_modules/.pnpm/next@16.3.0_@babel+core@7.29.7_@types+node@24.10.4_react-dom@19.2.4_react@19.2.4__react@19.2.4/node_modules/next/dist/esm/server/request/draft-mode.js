...
import { applyOwnerStack, RENDER_STAGES_BY_DATA_KIND } from '../dynamic-rendering-utils';
        ...
        case 'prerender-runtime':
            {
                ...
                if (stagedRendering) {
                    return stagedRendering.delayUntilStage(RENDER_STAGES_BY_DATA_KIND.sessionData, 'draftMode', new DraftMode(workUnitStore.draftMode));
                } else {
