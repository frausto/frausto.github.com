...
export function setBundlerFindSourceMapURLImplementation(findSourceMapURLImplementation) {
    ;
...
const sourceMapURLs = new LRUCache(512 * 1024 * 1024, (url, sourceURL)=>sourceURL.length + (url === invalidSourceMap ? 8 * 1024 : url.length));
