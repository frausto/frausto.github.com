...
import { makeDevtoolsIOAwarePromise, makeRuntimeHangingPromise, RENDER_STAGES_BY_DATA_KIND } from '../dynamic-rendering-utils';
                ...
                case 'prerender-runtime':
                    {
                        ...
                        if (stagedRendering) {
                            return stagedRendering.delayUntilStage(RENDER_STAGES_BY_DATA_KIND.sessionData, 'headers', workUnitStore.headers);
                        } else {
...
function makeHangingHeaders(workStore, prerenderStore) {
    ...
    const promise = makeRuntimeHangingPromise(prerenderStore.renderSignal, workStore.route, '`headers()`', prerenderStore);
...
function makeUntrackedHeadersWithDevWarnings(underlyingHeaders, route, requestStore) {
    ...
    const promise = makeDevtoolsIOAwarePromise(underlyingHeaders, requestStore, RENDER_STAGES_BY_DATA_KIND.sessionData);
