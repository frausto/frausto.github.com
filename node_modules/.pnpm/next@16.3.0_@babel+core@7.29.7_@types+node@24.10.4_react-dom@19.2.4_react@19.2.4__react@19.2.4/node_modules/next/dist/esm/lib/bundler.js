...
export function bundlerName(bundler) {
    switch(bundler){
        case 0:
            return 'Turbopack';
        case 1:
 ...
 */ export function getBundlerFromEnv() {
 ...
 */ export function finalizeBundlerFromConfig(fromOptions) {
    ...
    if (process.env.NEXT_RSPACK) {
        if (fromOptions !== 2) {
            Log.event(`Switching bundler from ${bundlerName(fromOptions)} to Rspack based on config`);
        }
        return 2;
    }
    return fromOptions;
