...
function _getInitialProps({ req, res, err }) {
    ...
    if (typeof window !== 'undefined') {
        ...
        const { getRequestMeta } = // TODO(browser-variant): migrate to a .ts/.browser.ts split so the browser bundle drops the server branch; see scripts/generate-browser-variant-aliases.mjs
        // ast-grep-ignore: no-typeof-window-require-tsx
        require('../server/request-meta');
